...
export class DenonClientAvrControl extends DenonClient {
  ...
  protected static readonly REVERSE_POWER_VALUES = Object.fromEntries(
    Object.entries(DenonClientAvrControl.PROTOCOL.POWER.VALUES).map(([key, value]) => [Number(value), key])
